...
\\
\>[B]{}\Varid{alice}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{id}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{alice}\;(\Conid{Fork}\;(\Varid{l},\Varid{r}))\mathrel{=}(\uncurry{\Varid{max}}\comp (\Varid{bob}\times\Varid{bob}))\;(\Varid{l},\Varid{r}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bob}\mathbin{::}\Conid{Ord}\;\Varid{c}\Rightarrow {\LTree}\;\Varid{c}\to \Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{bob}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{id}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{bob}\;(\Conid{Fork}\;(\Varid{l},\Varid{r}))\mathrel{=}(\uncurry{\Varid{min}}\comp (\Varid{alice}\times\Varid{alice}))\;(\Varid{l},\Varid{r}){}\<[E]%
\\[\blanklineskip]%

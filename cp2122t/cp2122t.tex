...
\begin{eqnarray*}
\start
     \ensuremath{\begin{lcbr}\Varid{a}\;(\Varid{leaf}\;\Varid{x})\mathrel{=}\Varid{id}\;\Varid{x}\\\Varid{a}\;(\Conid{Fork}\;(\Varid{t1},\Varid{t2}))\mathrel{=}\uncurry{\Varid{max}}\;(\Varid{b}\times\Varid{b})\;(\Varid{t1},\Varid{t2})\end{lcbr}}
%
\just\equiv{(72)}
%
...
\begin{eqnarray*}
\start
     \ensuremath{\begin{lcbr}\Varid{a}\comp \mathbf{in}\mathrel{=}\alt{\Varid{id}}{\uncurry{\Varid{max}}\comp (\p2\times\p2)}\comp \Conid{F}\;\conj{\Varid{a}}{\Varid{b}}\\\Varid{b}\comp \mathbf{in}\mathrel{=}\alt{\Varid{id}}{\uncurry{\Varid{min}}\comp (\p1\times\p1)}\comp \Conid{F}\;\conj{\Varid{a}}{\Varid{b}}\end{lcbr}}
%
\just\equiv{(52)}
%
...
%
     \ensuremath{\Varid{both}\mathrel{=}\llparenthesis\, \conj{\alt{\Varid{id}}{\uncurry{\Varid{max}}\comp (\p2\times\p2)}}{\alt{\Varid{id}}{\uncurry{\Varid{min}}\comp (\p1\times\p1)}}\,\rrparenthesis}
\qed
\end{eqnarray*}
...
com o tipo, como o bifuntor \ensuremath{\mathit B\;(\Conid{X},\Conid{Y})\mathrel{=}\Conid{X}\mathbin{+}((\Conid{Y}\times\Conid{Y})\times\Conid{Y})}, o baseLTree3 \ensuremath{\Varid{f}\;\Varid{g}\mathrel{=}\Varid{f}\mathbin{+}((\Varid{g}\times\Varid{g})\times\Varid{g})}.
...
&
    \ensuremath{\Conid{Tri}\mathbin{+}((\Conid{Tri}\times\Conid{Tri})\times\Conid{Tri})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}((}g2\ensuremath{\times}g2\ensuremath{)\times}g2\ensuremath{)}}
\\
...
&
    \ensuremath{\Conid{Tri}\mathbin{+}((\Conid{Tri}\times\Conid{Tri})\times\Conid{Tri})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}((}g1\ensuremath{\times}g1\ensuremath{)\times}g1\ensuremath{)}}
...
\begin{eqnarray*}
\start
     \ensuremath{\Varid{g1'}\;\Varid{x}\mathrel{=}\Varid{singl}\;\Varid{x}} 
%
\just\equiv{71}
%
     \ensuremath{\Varid{g1'}\mathrel{=}\Varid{singl}}
\qed
\end{eqnarray*}
...
\begin{eqnarray*}
\start
     \ensuremath{\Varid{g1''}\;((\Varid{x},\Varid{y}),\Varid{z})\mathrel{=}\Varid{x}\mathbin{+\!\!\!+}\Varid{y}\mathbin{+\!\!\!+}\Varid{z}} 
%
\just\equiv{passar ++ de infix para prefix duas vezes}
%
     \ensuremath{\Varid{g1''}\;((\Varid{x},\Varid{y}),\Varid{z})\mathrel{=}(\mathbin{+\!\!\!+})\;((\mathbin{+\!\!\!+})\;\Varid{x}\;\Varid{y})\;\Varid{z}} 
%
\just\equiv{(84) duas vezes}
%
     \ensuremath{\Varid{g1''}\;((\Varid{x},\Varid{y}),\Varid{z})\mathrel{=}\uncurry{(\mathbin{+\!\!\!+})}\;(\uncurry{(\mathbin{+\!\!\!+})}\;(\Varid{x},\Varid{y}),\Varid{z})} 
%
\just\equiv{(73), (77), (72)}
%
     \ensuremath{\Varid{g1''}\;((\Varid{x},\Varid{y}),\Varid{z})\mathrel{=}\uncurry{(\mathbin{+\!\!\!+})}\comp (\uncurry{(\mathbin{+\!\!\!+})}\times\Varid{id})\;((\Varid{x},\Varid{y}),\Varid{z})} 
%
\just\equiv{(71)}
%
     \ensuremath{\Varid{g1''}\mathrel{=}\uncurry{(\mathbin{+\!\!\!+})}\comp (\uncurry{(\mathbin{+\!\!\!+})}\times\Varid{id})} 
\qed
\end{eqnarray*}
...
\begin{eqnarray*}
\start
     \ensuremath{g_2 \;\Varid{f}\mathrel{=}\alt{\Varid{return}\comp \Varid{nil}}{\Varid{monad\char95 cons}}\comp (\Varid{id}\mathbin{+}\Varid{f}\times\Varid{id})}
%
\just\equiv{(22); (1)}
%
     \ensuremath{g_2 \;\Varid{f}\mathrel{=}\alt{\Varid{return}\comp \Varid{nil}}{\Varid{monad\char95 cons}\comp (\Varid{f}\times\Varid{id})}}
\qed
\end{eqnarray*}
...
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{M}\;\mathit B\times\Conid{M}\;[\mskip1.5mu \mathit B\mskip1.5mu]}
          \ar[ul]^{\ensuremath{\alt{\Varid{return}\comp \Varid{nil}}{\Varid{monad\char95 cons}}}}
}
\end{eqnarray*}
...
\ensuremath{\alt{\Varid{return}\comp \Varid{nil}}{\Varid{monad\char95 cons}\;\Varid{f}}}.
\end{enumerate}
...
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{M}\;\Conid{Bit}\times\Conid{M}\;[\mskip1.5mu \Conid{Bit}\mskip1.5mu]}
            \ar[uuul]^{\ensuremath{\alt{\Varid{return}\comp \Varid{nil}}{\Varid{monad\char95 cons}}}}
}
\end{eqnarray*}

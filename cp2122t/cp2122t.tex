...
\column{6}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}g_1 \mathrel{=}\alt{\Varid{nil}}{\uncurry{(\mathbin{+\!\!\!+})}\comp ((\uncurry{(\mathbin{+\!\!\!+})}\times\Varid{id}))}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t1}\mathrel{=}(((\Varid{x},\Varid{y}),\Varid{s}\mathbin{\Varid{`div`}}\mathrm{2}),\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t2}\mathrel{=}(((\Varid{x}\mathbin{+}\Varid{s}\mathbin{\Varid{`div`}}\mathrm{2},\Varid{y}),\Varid{s}\mathbin{\Varid{`div`}}\mathrm{2}),\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t3}\mathrel{=}(((\Varid{x},\Varid{y}\mathbin{+}\Varid{s}\mathbin{\Varid{`div`}}\mathrm{2}),\Varid{s}\mathbin{\Varid{`div`}}\mathrm{2}),\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Para se definir \ensuremath{\Varid{propagate3}}, é necessário explicitar os tipos de \ensuremath{\Varid{f}\mathbin{::}(\Conid{Monad}\;\Varid{m})\Rightarrow (\Conid{Bit3}\to \Varid{m}\;\Conid{Bit3})}, 
já que se pretende que \ensuremath{\Varid{propagate3}} triplique cada \ensuremath{\Conid{Bit}} da lista de entrada para uma estrutura do tipo \ensuremath{\Conid{Bit3}}.
...
\item Aplicar \ensuremath{\Varid{f}} (especificamente \ensuremath{\Varid{bflip3}}) a \ensuremath{\Conid{Bit3}}, produzindo \ensuremath{\Varid{m}\;\Conid{Bit3}}.
...
Tal com anteriormente, todos estes passos podem ser compostos numa só função por sucessivas aplicações da regra de \ensuremath{\Varid{absorção}\mathbin{-+}}.

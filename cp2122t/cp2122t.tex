...
com o tipo, como o bifuntor B(X,Y) = X -\ensuremath{\mathbin{-}((\Conid{Y}\times\Conid{Y})\times\Conid{Y}),\Varid{o}\;\Varid{baseLTree3}\;\Varid{f}\;\Varid{g}\mathrel{=}\Varid{f}\mathbin{-}}- ((g >< g) >< g).
